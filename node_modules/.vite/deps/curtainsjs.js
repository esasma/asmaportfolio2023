...
var CallbackQueueManager = class {
  constructor() {
    this.clear();
  }
  clear() {
...
var Texture = class {
  ...
  setScale(scale2) {
    ...
    scale2.sanitizeNaNValuesWith(this.scale).max(tempVec2.set(1e-3, 1e-3));
...
var PlaneTextureLoader = class extends TextureLoader {
...
var DOMMesh = class extends Mesh {
...
var Plane = class extends DOMMesh {
  ...
  setScale(scale2) {
    ...
    scale2.sanitizeNaNValuesWith(this.scale).max(tempScale.set(1e-3, 1e-3));
...
var ShaderPass = class extends DOMMesh {
  constructor(renderer, {
    widthSegments,
    heightSegments,
    renderOrder,
...
var PingPongPlane = class extends Plane {
...
//# sourceMappingURL=curtainsjs.js.map
